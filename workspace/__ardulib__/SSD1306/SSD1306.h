...
public:
    SSD1306(TwoWire* wire, uint8_t i2cAddress, uint8_t width, uint8_t height);
    ~SSD1306();
    ...
    void renderScanlinePart(int16_t scanline, int16_t xmin, int16_t xmax, uint16_t* lineBuffer);
